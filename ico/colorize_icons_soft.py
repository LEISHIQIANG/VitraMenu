...
# Softened Windows Blue - lighter and less aggressive
target_blue = (60, 140, 230) 
...
def solid_color_apply_soft():
    ...
    for png_name, ico_name in mapping.items():
        ...
        try:
            ...
            print(f"Soft Blue Applied: {png_name}")
            
        except Exception as e:
            print(f"Error {png_name}: {e}")

if __name__ == "__main__":
    solid_color_apply_soft()
